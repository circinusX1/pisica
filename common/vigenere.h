...
int index(char c);
std::string extend_key(const std::string& msg, std::string& key);
std::string encrypt_vigenere(const std::string& msg, std::string& key);
std::string decrypt_vigenere(const std::string& encryptedMsg, std::string& newKey) ;
...
inline std::string xdecrypt( const std::string& encrypted_msg,  std::string& key) {
